...
<div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-4">
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.laporan.pdf', request()->query()) }}" class="flex items-center gap-2 bg-[#fee2e2] hover:bg-[#fca5a5] text-[#991b1b] px-4 py-2 rounded-lg font-label-md text-sm transition-colors border border-[#fca5a5]">
            <span class="material-symbols-outlined" style="font-size: 18px;">picture_as_pdf</span>
            Export PDF
        </a>
        <a href="{{ route('admin.laporan.excel', request()->query()) }}" class="flex items-center gap-2 bg-[#d1fae5] hover:bg-[#6ee7b7] text-[#065f46] px-4 py-2 rounded-lg font-label-md text-sm transition-colors border border-[#6ee7b7]">
